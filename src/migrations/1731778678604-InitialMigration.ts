...
export class InitialMigration1731778678604 implements MigrationInterface {
    name = 'InitialMigration1731778678604'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_character" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "level" integer NOT NULL DEFAULT (1), "attack" integer NOT NULL DEFAULT (10), "defense" integer NOT NULL DEFAULT (10), "health" integer NOT NULL DEFAULT (10), "agility" integer NOT NULL DEFAULT (10), "role" varchar CHECK( "role" IN ('guerreiro','mago','arqueiro') ) NOT NULL DEFAULT ('guerreiro'), "id_user" integer NOT NULL, "experience" integer NOT NULL DEFAULT (0))`);
        await queryRunner.query(`INSERT INTO "temporary_character"("id", "name", "level", "attack", "defense", "health", "agility", "role", "id_user") SELECT "id", "name", "level", "attack", "defense", "health", "agility", "role", "id_user" FROM "character"`);
        await queryRunner.query(`DROP TABLE "character"`);
        await queryRunner.query(`ALTER TABLE "temporary_character" RENAME TO "character"`);
        await queryRunner.query(`CREATE TABLE "temporary_character" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "level" integer NOT NULL DEFAULT (1), "attack" integer NOT NULL DEFAULT (10), "defense" integer NOT NULL DEFAULT (10), "health" integer NOT NULL DEFAULT (10), "agility" integer NOT NULL DEFAULT (10), "role" varchar CHECK( "role" IN ('guerreiro','mago','arqueiro') ) NOT NULL DEFAULT ('guerreiro'), "id_user" integer, "experience" integer NOT NULL DEFAULT (0))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "character"("id", "name", "level", "attack", "defense", "health", "agility", "role", "id_user") SELECT "id", "name", "level", "attack", "defense", "health", "agility", "role", "id_user" FROM "temporary_character"`);
        await queryRunner.query(`DROP TABLE "temporary_character"`);
    }
